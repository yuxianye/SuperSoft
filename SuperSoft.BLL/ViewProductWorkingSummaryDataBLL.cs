...
namespace SuperSoft.BLL
{
    public class ViewProductWorkingSummaryDataBLL : MyClassBase
    {
        ...
        /// View-数据库访问对象
        /// </summary>
        private ViewProductWorkingSummaryDataDAL dAL = new ViewProductWorkingSummaryDataDAL();
        ...
        public ViewProductWorkingSummaryData GetById(Guid id)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public IEnumerable<ViewProductWorkingSummaryData> GetByCondition(
            Expression<Func<ViewProductWorkingSummaryData, bool>> predicate)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </param>
        /// <returns>实体对象集合</returns>
        public IEnumerable<ViewProductWorkingSummaryData> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ViewProductWorkingSummaryData, bool>> predicate)
        {
            if (Disposed)
            {
        ...
        /// <returns>实体对象集合</returns>
        public IEnumerable<ViewProductWorkingSummaryData> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ViewProductWorkingSummaryData, bool>> predicate, int pageIndex, int pageSize)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
