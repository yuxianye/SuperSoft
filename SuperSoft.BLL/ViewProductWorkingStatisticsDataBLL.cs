...
namespace SuperSoft.BLL
{
    public class ViewProductWorkingStatisticsDataBLL : MyClassBase
    {
        ...
        /// View-数据库访问对象
        /// </summary>
        private ViewProductWorkingStatisticsDataDAL dAL = new ViewProductWorkingStatisticsDataDAL();
        ...
        public ViewProductWorkingStatisticsData GetById(Guid id)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public IEnumerable<ViewProductWorkingStatisticsData> GetByCondition(
            Expression<Func<ViewProductWorkingStatisticsData, bool>> predicate)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </param>
        /// <returns>实体对象集合</returns>
        public IEnumerable<ViewProductWorkingStatisticsData> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ViewProductWorkingStatisticsData, bool>> predicate)
        {
            if (Disposed)
            {
        ...
        /// <returns>实体对象集合</returns>
        public IEnumerable<ViewProductWorkingStatisticsData> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ViewProductWorkingStatisticsData, bool>> predicate, int pageIndex, int pageSize)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
