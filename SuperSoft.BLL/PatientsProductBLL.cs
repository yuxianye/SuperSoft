...
namespace SuperSoft.BLL
{
    public class PatientsProductBLL : MyClassBase
    {
        ...
        /// 患者产品的数据库访问对象
        /// </summary>
        private PatientsProductDAL dAL = new PatientsProductDAL();
        ...
        /// <returns></returns>
        public void Insert(PatientsProduct entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Insert(IEnumerable<PatientsProduct> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </summary>
        /// <param name="entity">一个实体对象</param>
        public void Delete(PatientsProduct entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </summary>
        /// <param name="entitys">实体对象集合</param>
        public void Delete(IEnumerable<PatientsProduct> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// v.Height == 100;
        /// </param>
        public void Delete(Expression<Func<PatientsProduct, bool>> condition)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Update(PatientsProduct entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Update(IEnumerable<PatientsProduct> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public PatientsProduct GetById(Guid id)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public IEnumerable<PatientsProduct> GetByCondition(Expression<Func<PatientsProduct, bool>> predicate)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </param>
        /// <returns>实体对象集合</returns>
        public IEnumerable<PatientsProduct> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<PatientsProduct, bool>> predicate)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// <returns>实体对象集合</returns>
        public IEnumerable<PatientsProduct> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<PatientsProduct, bool>> predicate, int pageIndex, int pageSize)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
