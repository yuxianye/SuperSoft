...
{
    public class ViewPatientProductsBLL : MyClassBase
    {
        /// <summary>
        /// View-患者产品的数据库访问对象
        /// </summary>
        private ViewPatientsProductDAL dAL = new ViewPatientsProductDAL();
        ...
        public ViewPatientsProduct GetById(Guid id)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public IEnumerable<ViewPatientsProduct> GetByCondition(Expression<Func<ViewPatientsProduct, bool>> predicate)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </param>
        /// <returns>实体对象集合</returns>
        public IEnumerable<ViewPatientsProduct> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ViewPatientsProduct, bool>> predicate)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// <returns>实体对象集合</returns>
        public IEnumerable<ViewPatientsProduct> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ViewPatientsProduct, bool>> predicate, int pageIndex, int pageSize)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
