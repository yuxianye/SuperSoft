...
namespace SuperSoft.BLL
{
    public class ProductWorkingSummaryDataBLL : MyClassBase
    {
        ...
        /// 概要数据的数据库访问对象
        /// </summary>
        private ProductWorkingSummaryDataDAL dAL = new ProductWorkingSummaryDataDAL();
        ...
        /// <returns></returns>
        public void Insert(ProductWorkingSummaryData entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Insert(IEnumerable<ProductWorkingSummaryData> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </summary>
        /// <param name="entity">一个实体对象</param>
        public void Delete(ProductWorkingSummaryData entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </summary>
        /// <param name="entitys">实体对象集合</param>
        public void Delete(IEnumerable<ProductWorkingSummaryData> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// v.Height == 100;
        /// </param>
        public void Delete(Expression<Func<ProductWorkingSummaryData, bool>> condition)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Update(ProductWorkingSummaryData entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Update(IEnumerable<ProductWorkingSummaryData> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public ProductWorkingSummaryData GetById(Guid id)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public IEnumerable<ProductWorkingSummaryData> GetByCondition(
            Expression<Func<ProductWorkingSummaryData, bool>> predicate)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </param>
        /// <returns>实体对象集合</returns>
        public IEnumerable<ProductWorkingSummaryData> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ProductWorkingSummaryData, bool>> predicate)
        {
            if (Disposed)
            {
        ...
        /// <returns>实体对象集合</returns>
        public IEnumerable<ProductWorkingSummaryData> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ProductWorkingSummaryData, bool>> predicate, int pageIndex, int pageSize)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
