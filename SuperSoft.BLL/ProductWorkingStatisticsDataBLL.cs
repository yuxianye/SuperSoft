...
{
    public class ProductWorkingStatisticsDataBLL : MyClassBase
    {
        /// <summary>
        /// 统计数据的数据库访问对象
        /// </summary>
        private ProductWorkingStatisticsDataDAL dAL = new ProductWorkingStatisticsDataDAL();
        ...
        /// <returns></returns>
        public void Insert(ProductWorkingStatisticsData entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Insert(IEnumerable<ProductWorkingStatisticsData> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </summary>
        /// <param name="entity">一个实体对象</param>
        public void Delete(ProductWorkingStatisticsData entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </summary>
        /// <param name="entitys">实体对象集合</param>
        public void Delete(IEnumerable<ProductWorkingStatisticsData> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// v.Height == 100;
        /// </param>
        public void Delete(Expression<Func<ProductWorkingStatisticsData, bool>> condition)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Update(ProductWorkingStatisticsData entity)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public void Update(IEnumerable<ProductWorkingStatisticsData> entitys)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public ProductWorkingStatisticsData GetById(Guid id)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        public IEnumerable<ProductWorkingStatisticsData> GetByCondition(
            Expression<Func<ProductWorkingStatisticsData, bool>> predicate)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
        ...
        /// </param>
        /// <returns>实体对象集合</returns>
        public IEnumerable<ProductWorkingStatisticsData> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ProductWorkingStatisticsData, bool>> predicate)
        {
            if (Disposed)
            {
        ...
        /// <returns>实体对象集合</returns>
        public IEnumerable<ProductWorkingStatisticsData> GetByCondition(PropertySortCondition sortCondition,
            Expression<Func<ProductWorkingStatisticsData, bool>> predicate, int pageIndex, int pageSize)
        {
            if (Disposed)
            {
                throw new ObjectDisposedException(ToString());
